        ...
        <div className='px-8 pb-12 text-indigo-200 bangraoud-color'>
            ...
            <div className='grid md:grid-cols-4 gap-4'>
                <div className="program-card">
                    <img className='h-20 w-16 mr-4' src={program1} alt="" />
                    <div>
                ...
                <div className="program-card">
                    <img className='h-20 w-16 mr-4' src={program2} alt="" />
                    <div>
                ...
                <div className="program-card">
                    <img className='h-20 w-16 mr-4' src={program3} alt="" />
                    <div>
                ...
                <div className="program-card">
                    <img className='h-20 w-16 mr-4' src={program4} alt="" />
                    <div>
